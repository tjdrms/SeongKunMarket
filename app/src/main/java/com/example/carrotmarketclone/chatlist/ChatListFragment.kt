package com.example.carrotmarketclone.chatlist
...
import com.example.carrotmarketclone.chatdetail.ChatRoomActivity
import com.example.carrotmarketclone.databinding.FragmentChatlistBinding
import com.example.carrotmarketclone.home.ArticleAdapter
...
class ChatListFragment: Fragment(R.layout.fragment_chatlist) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chatListAdapter = ChatListAdapter(onItemCliked = { chatRoom ->
            context?.let {
